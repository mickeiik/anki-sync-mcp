...
| `ANKI_MAX_IMPORT_BYTES` | `268435456` | Maximum size of an importable `.apkg` or `.csv` file in the imports folder (`1048576`-`4294967296` bytes); larger files are rejected before parsing. |
